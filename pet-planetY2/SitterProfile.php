...
<div class="sitterprofilecontent">
    <div class="container">
        <div class="sitterinfo">
            <a href="UpdateSitter.php?id=<?= $_SESSION['user']->id ?>">
            ...
            <div class="aboutsitter">
                ...
                <div class="all">
                    ...
                    <div class="right">
                        ...
                        $Sitteraddress = $address->getAddressInfoByUserId($_SESSION['user']->id);
                        ?>
        ...
        <div class="myservice">
            ...
            <?php
            $sitter = new Sitter;
            $sitter->setAddress_id($Sitteraddress->id);
            $sitterinfo = $sitter->retrieveSitterInfoByAddressId($Sitteraddress->id);
            ?>
            <div class="serviceinfo">
                <div class="all-2">
                    ...
                    <div class="right-2">
                        <p>Pet Sitter </p>
                        <hr>
                        <P><?= $sitterinfo['price_per_hour'] ?></P>
                        <hr>
                        <p>&nbsp;&nbsp;&nbsp;&nbsp; <?= $sitterinfo['work_days'] ?></p>
                        <hr>
                    </div>
                </div>
            </div>
            <button type="button" class="btn btn-primary btn-lg"><a style="text-decoration: none; color: white;" href="ViewSitterAppointments.php">View Reservations </a> </button>
