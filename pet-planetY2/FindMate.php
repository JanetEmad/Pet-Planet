...
$pet = new Pet;
$pets = $pet->getAvailablePetsForMating()->fetch_all(MYSQLI_ASSOC);

if ($_GET && isset($_GET['cat'])) {
    $pet = new Pet;
    $pet->setCategory_id($_GET['cat']);
    $pets = $pet->getPetByCat('mate')->fetch_all(MYSQLI_ASSOC);
}
...
<body>
    ...
    <div class="findmatecontent">
        ...
        <h3>Find Your Future Best Pet's Mate</h3>

        <div class="circles">
            <div class="row">

                <div class="col-xs-2">
                    <a href="FindMate.php?cat=1" onclick="changeImage(this)">
                ...
                <div class="col-xs-2 col-half-offset">
                    <a href="FindMate.php?cat=2" onclick="changeImage(this)">
                        <div class="circle one">
                ...
                <div class="col-xs-2 col-half-offset">
                    <a href="FindMate.php?cat=3" onclick="changeImage(this)">
                        <div class="circle one">
                ...
                <div class="col-xs-2 col-half-offset">
                    <a href="FindMate.php?cat=4" onclick="changeImage(this)">
                        <div class="circle one">
                ...
                <div class="col-xs-2 col-half-offset">
                    <a href="FindMate.php?cat=5" onclick="changeImage(this)">
                        <div class="circle one">
        ...
        <h3>Pets Available For Mating</h3>
            ...
            <div class="row">
                ...
                <?php if (!empty($pets)) { ?>
                    ...
                    <?php foreach ($pets as $pet) { ?>
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3">
                            <a href="PetProfileForOperation.php?mate=<?= $pet['id'] ?>">
                                <div class="result">
                                    <div class="image">
