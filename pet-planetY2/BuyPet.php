...
$pet = new Pet;
$pets = $pet->getAvailablePetsForBuying()->fetch_all(MYSQLI_ASSOC);

if ($_GET && isset($_GET['cat'])) {
    $pet = new Pet;
    $pet->setCategory_id($_GET['cat']);
    $pets = $pet->getPetByCat('buy')->fetch_all(MYSQLI_ASSOC);
}
...
<body>
    ...
    <div class="buypetcontent">
        ...
        <div class="circles" style="margin-left: 20%;">
            <div class="row">

                <div class="col-xs-2">
                    <a href="BuyPet.php?cat=1" onclick="changeImage(this)">
                ...
                <div class="col-xs-2 col-half-offset">
                    <a href="BuyPet.php?cat=2" onclick="changeImage(this)">
                        <div class="circle one">
                ...
                <div class="col-xs-2 col-half-offset">
                    <a href="BuyPet.php?cat=3" onclick="changeImage(this)">
                        <div class="circle one">
                ...
                <div class="col-xs-2 col-half-offset">
                    <a href="BuyPet.php?cat=4" onclick="changeImage(this)">
                        <div class="circle one">
                ...
                <div class="col-xs-2 col-half-offset">
                    <a href="BuyPet.php?cat=5" onclick="changeImage(this)">
                        <div class="circle one">
        ...
        <h3>Pets Available For Buying</h3>
            ...
            <div class="row">
                ...
                <?php if (!empty($pets)) { ?>
                    ...
                    <?php foreach ($pets as $pet) { ?>
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3">
                            <a href="PetProfileForOperation.php?buy=<?= $pet['id'] ?>">
                                <div class="result">
                                    <div class="image">
